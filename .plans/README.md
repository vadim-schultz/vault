...
| 1 — Empty repo, green CI | In progress | [chapter_1.plan.md](chapter_1.plan.md) |
| 2 — Documentation skeleton | Pending | [chapter_0.plan.md](chapter_0.plan.md#chapter-2--documentation-skeleton) |
| 3 — `vault init` + storage | Pending | [chapter_0.plan.md](chapter_0.plan.md#chapter-3--vault-init--storage-foundation) |
| 4 — Background watcher | Pending | [chapter_0.plan.md](chapter_0.plan.md#chapter-4--background-watcher-automatic-after-init) |
